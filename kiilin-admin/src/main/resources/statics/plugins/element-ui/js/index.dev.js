      ...
      t.
        ...
        created: function() {
          ...
          if ("expand" === n) return i.renderExpanded = function(e, t) {
            return h.$scopedSlots.
              default ?h.$scopedSlots.
              default (t):
              h.$slots.
                default
        ...
        p = function e(t) {
          if (!r.
            ...
            t.onClose = function() {
              ...
              default = [t.message], t.message = "REPLACED_BY_VNODE"), d.id = n, d.$mount(), document.body.appendChild(d.$el), d.visible = !0, d.dom = d.$el, d.dom.style.zIndex = l.PopupManager.nextZIndex();
            var a = t.offset || 0;
