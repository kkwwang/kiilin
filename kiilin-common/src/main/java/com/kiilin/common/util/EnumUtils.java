...
public class EnumUtils {
    ...
    protected static void setFailsafeFieldValue(Field field, Object target, Object value) throws NoSuchFieldException, IllegalAccessException {
    ...
    protected static void cleanEnumCache(Class<?> enumClass) throws NoSuchFieldException, IllegalAccessException {
    ...
    public static <T extends Enum<?>> void addEnum(Class<?> enumType,
